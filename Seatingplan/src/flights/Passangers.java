...
public class Passangers extends JFrame {
	...
	public void departingSeat() {
		...
		/*
		for(String s: b747.departureSeatsB747) {
			departing.add(s);
		}

		//departing.remove(departingSeat.getSelectedIndex());

		for(String s: a318View.departureSeatsA318) {
			departing.add(s);
		}
		*/
		departing.add("1A");
	...
	public void formForTickets() {
		...
		if (!errorCount) {
			...
			if (B747.numberOfTickets > 1) {
				...
				new Passangers().setVisible(false);
